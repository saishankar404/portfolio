---
title: kumo
description: An open research engine that doesn't look like it's from 2004.
image: /assets/kumo_logo_cover.png
videoUrl: /assets/kumo-final-launch.mp4
videoThumbnail: /assets/thumbnail-kumo.png
...
to keep kumo completely frictionless, we structured the experience around what matters... **find**... **route**... **read**.

**open access first:** we built around openalex and unpaywall. users get results that actually link to readable papers right from the start. no paywalls, no "click here to request access" dead ends. new users see papers they can actually read immediately; returning users pick up exactly where they left off.
